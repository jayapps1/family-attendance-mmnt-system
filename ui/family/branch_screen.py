...
class BranchDetails(tk.Toplevel):
    def __init__(self, app, data):
        ...
        self.tree.heading("#0", text="Generation / member")
        self.tree.heading("number", text="Family number")
        self.tree.heading("status", text="Living status")
        self.tree.column("#0", width=400)
        self.tree.column("number", width=170)
